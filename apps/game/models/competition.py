...
class SingleMatch(models.Model):
    ...
    part1_log = models.FileField(upload_to=get_log_file_directory, blank=True, null=True)
    part2_log = models.FileField(upload_to=get_log_file_directory, blank=True, null=True)
